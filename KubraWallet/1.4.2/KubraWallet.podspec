Pod::Spec.new do |s|
  s.name             = "KubraWallet"
  s.version          = '1.4.2' # x-release-please-version
  ...
  s.source           = { :http => "https://ios-compiled-sdk-frameworks.s3.us-west-2.amazonaws.com/version/1.4.2/KubraWallet.zip" , :sha256 => "fbdc2bbfc470feba7b67a9962402d328f512c764cddc575ce5d1dadefc5b4d0e" }
