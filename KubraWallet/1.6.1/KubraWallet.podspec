Pod::Spec.new do |s|
  s.name             = "KubraWallet"
  s.version          = '1.6.1' # x-release-please-version
  ...
  s.source           = { :http => "https://ios-compiled-sdk-frameworks.s3.us-west-2.amazonaws.com/version/1.6.1/KubraWallet.zip" , :sha256 => "091fa9a2501dfc842a529858c102a85697164f8951666923184e043add70770a" }
