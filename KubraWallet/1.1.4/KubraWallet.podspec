Pod::Spec.new do |s|
  s.name             = "KubraWallet"
  s.version          = "1.1.4" # x-release-please-version
  ...
  s.source           = { :http => "https://ios-compiled-sdk-frameworks.s3.us-west-2.amazonaws.com/version//1.1.4/KubraWallet.zip" , :sha256 => "3cd52dfb04cffe8679dbefc51a11d9220fc39f46bd329114262040b5f1413029" }
